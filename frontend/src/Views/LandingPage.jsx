  ...
  return (
    <>
      ...
      <div className={styles['slogan-container']}>
        <h1 className={`${styles['quicksand-regular']} ${styles['slogan-first-line']}`}>
          Can't decide what to eat? no worries
          <br />
          <b className={`${styles['quicksand-bold']} ${styles['slogan-second-line']}`}>
      ...
      <div className={styles['CTAs-container']}>
        <div className={`${styles['CTA']} ${styles['CTA-takeout']}`}>
          ...
          <button id={`${styles['CTA-button-takeout']}`} className={styles["quicksand-bold"]}>
            Takeout
          </button>
        </div>
        <div className={`${styles['CTA']} ${styles['CTA-cook']}`}>
          ...
          <button id={`${styles['CTA-button-cook']}`} className={styles["quicksand-bold"]}>
            Cook at home 
          </button>
        </div>
      </div>      
